...
This post contains [TLA+](https://learntla.com/) solutions for [The Deadlock Empire](https://deadlockempire.github.io/) which is a collection of challenges where the objective is to break multithreaded programs by playing the role of a scheduler that can context switch at any time.
