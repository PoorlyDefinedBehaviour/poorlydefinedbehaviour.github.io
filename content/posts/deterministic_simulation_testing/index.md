...
The seed will be used to generate the same sequence of inputs when something goes wrong and the system will end up hitting the same bug. *Bugs are reproducible* by running the simulation with the seed that was used when the bug was found.
